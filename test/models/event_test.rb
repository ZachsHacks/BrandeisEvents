...
class EventTest < ActiveSupport::TestCase
	...
	def setup
		@host = User.create(uid: "zweiss", first_name: "Example", last_name: "User", email: "user@example.com", provider: "google", can_host: true, is_admin: false)
		@guest = User.create(uid: "acarr", first_name: "Example1", last_name: "User1", email: "user1@example.com", provider: "google", can_host: false, is_admin: false)
